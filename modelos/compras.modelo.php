...
class ModeloCompras{
	...
	static public function mdlEditarCompra($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET  id_usuario = :id_usuario, id_proveedor = :id_proveedor, productos = :productos, impuesto = :impuesto, neto = :neto, total= :total, metodo_pago = :metodo_pago WHERE codigo = :codigo");
